    ...
    <footer id="contact" className="relative bg-black border-t border-gray-800/50">
      ...
      <div className="relative z-10 border-b border-gray-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          >
            <h3 className="text-3xl sm:text-4xl font-bold text-white mb-4">Получайте советы по росту</h3>
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              Еженедельные инсайты по продвижению в Telegram и Max — кейсы, лайфхаки и тренды мессенджер-маркетинга.
            </p>
          </motion.div>
        ...
        >
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0 text-center sm:text-left">
            <p className="text-gray-500 text-sm">
              {new Date().getFullYear()} GoChat. Все права защищены.
            </p>
